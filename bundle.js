...
/***/ function(module, exports, __webpack_require__) {
	...
	var authEvents = __webpack_require__(26);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getPets = function getPets(petSuccess, failure, KEY) {
	  $.ajax({
	    method: 'GET',
	    url: app.api + '/pets'
	  }).done(petSuccess).fail(failure);
	};

	var addFavorite = function addFavorite(petName, userID, petDescription, success, failure) {
	...
	var deleteFavorite = function deleteFavorite(petID, deleteSuccess, failure) {
	  $.ajax({
	    method: 'DELETE',
	...
	var getFavorites = function getFavorites(favoritesSuccess, failure) {
	  $.ajax({
	    method: 'GET',
	    url: app.api + '/favorites',
	    headers: {
	  ...
	  }).done(favoritesSuccess).fail(failure);
	};

	var applyFavorite = function applyFavorite(petID, updateFavoriteSuccess, failure) {
	  $.ajax(_defineProperty({
	    method: 'PATCH',
	    url: app.api + '/favorites/' + petID,
	    data: {
	    ...
	    Authorization: 'Token token=' + app.user.token
	  })).done(updateFavoriteSuccess).fail(failure);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "    <div class=\"col-md-6\">\n      <div class=\" view view-first\">\n        <div class=\"image-container\"><img src=\" "
	    + alias2(alias1(((stack1 = ((stack1 = ((stack1 = ((stack1 = (depth0 != null ? depth0.media : depth0)) != null ? stack1.photos : stack1)) != null ? stack1.photo : stack1)) != null ? stack1["0"] : stack1)) != null ? stack1.$t : stack1), depth0))
	    + " \" class=\"pet-image\"></div>\n        <div class=\"mask\">\n          <div class=\"pet-name\">\n            <h3>"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.name : depth0)) != null ? stack1.$t : stack1), depth0))
	    + "</h3>\n            <button type=\"button\" id=\"addPetButton\" data-name=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.name : depth0)) != null ? stack1.$t : stack1), depth0))
	    + "\" data-description=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.description : depth0)) != null ? stack1.$t : stack1), depth0))
	    + "\" class=\"pet-button\"><span class=\"glyphicon glyphicon-heart\" aria-hidden=\"true\"></span></button>\n            <div class=\"pet-description\">\n              <p>"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.description : depth0)) != null ? stack1.$t : stack1), depth0))
	    + "</p>\n            </div>\n          </div>\n        </div>\n      </div>\n    </div>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    var stack1;

	  return "<div class=\"row bucket-row\">\n  <h2 class=\"pets-header\">Available Dogs</h2>\n"
...
/***/ function(module, exports, __webpack_require__) {
	...
	var authApi = __webpack_require__(28);
	var authUi = __webpack_require__(29);
	var petfinder = __webpack_require__(32);
	var app = __webpack_require__(5);
	...
	var addHandlers = function addHandlers() {
	  ...
	  $('.petResultsTemplate').on('click', '#addPetButton', function () {
	    ...
	    var petDescription = $(this).data("description");
...
/***/ function(module, exports, __webpack_require__) {
	...
	var loadPets = __webpack_require__(30);
	var petfinder = __webpack_require__(32);
	var authUi = __webpack_require__(29);
	...
	var petSuccess = function petSuccess(data) {
	  console.log(data);
	  loadPets.loadPets(data);
	};

	var favoritesSuccess = function favoritesSuccess(data) {
	...
	var favoriteUpdateSuccess = function favoriteUpdateSuccess() {
	...
	module.exports = {
	  ...
	  favoritesSuccess: favoritesSuccess,
	  favoriteUpdateSuccess: favoriteUpdateSuccess
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var loadPets = function loadPets(data) {
	  console.log("Loaded pets handlebars");
	  console.log(data);
	  var handlebarsTemplate = __webpack_require__(6);
	...
	var loadFavorites = function loadFavorites(data) {
	  console.log("Loaded favorites handlebars");
	  console.log('data ', data);
	  var favoritesTemplate = __webpack_require__(31);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "      <div class=\"row\">\n        <div class=\"col-md-8\">\n          <h3>"
	    ...
	    + "</p>\n          </div>\n        </div>\n        <div class=\"col-md-4 favorite-button\">\n          <button type=\"button\" id=\"deletePetButton\" data-id=\""
	    + alias2(alias1((depth0 != null ? depth0.id : depth0), depth0))
	    + "\" class=\"pet-button\"> <span class=\"glyphicon glyphicon-remove\" aria-hidden=\"true\"></span></button>\n          <button type=\"button\" id=\"applyPetButton\" data-id=\""
	    + alias2(alias1((depth0 != null ? depth0.id : depth0), depth0))
	    + "\" class=\"pet-button\"> <span class=\"glyphicon glyphicon-ok\" aria-hidden=\"true\"></span></button>\n        </div>\n      </div>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    var stack1;

	  return "<div class=\"favHBS\">\n  <h1 class='favorites-header'>Favorites</h1>\n\n  <div class=\"favorite-info container-fluid\">\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.favorites : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
	    + "  </div>\n</div>\n";
	},"useData":true});
